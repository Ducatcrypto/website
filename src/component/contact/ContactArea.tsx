...
const contact_data: DataType[] = [
   {
      ...
      title: "Location",
      info: (<>123 Crypto Lane. <br /> Blockchain City, BC 45678</>),
   },
   {
      id: 2,
      icon: "fas fa-phone-alt",
      title: "Contact",
      info: (<><Link href="tel:+1(234)567-8900">+1 (234) 567-8900</Link></>),
   },
   {
      id: 3,
      icon: "fas fa-envelope",
      title: "Email",
      info: (<><Link href="mailto:support@ducat.io">support@ducat.io</Link> <br /> </>),
   },
   {
      id: 4,
